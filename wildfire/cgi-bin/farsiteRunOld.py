...
class farsiteRun():
	...
	def main(self,result):
		...
		curlstring = 'curl -G -u demo:demo -d "id='+str(runid)+'&coords=' + point + '&template='+template+'&weather='+ weatherString +'&wind=' + windString + '&day='+startDay+'&month='+startMonth+'&hour='+startHour+'&min=00&interval=1&duration=6" ' + url
		print curlstring
		#print callstring
